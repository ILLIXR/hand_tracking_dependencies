...
if(tfl-XNNPACK_FOUND)
    ...
    ExternalProject_Add(
            ...
            GIT_TAG accb921d04dbbbaaaafaa73b1f6274f11124c76a
            GIT_PROGRESS TRUE
            PREFIX "${CMAKE_BINARY_DIR}/${EPA}"
            DOWNLOAD_EXTRACT_TIMESTAMP TRUE
            CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DXNNPACK_BUILD_TESTS=OFF -DXNNPACK_BUILD_BENCHMARKS=OFF
            DEPENDS ${ruy_DEP}
    )
endif()
