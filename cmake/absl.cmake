...
if(absl_FOUND)
    ...
    if(WIN32 OR MSVC)
        message(FATAL_ERROR "Please install abseil with vcpkg")
    else()
        ...
        ExternalProject_Add(
                ...
                CMAKE_ARGS -DABSL_ENABLE_INSTALL=ON -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DABSL_USE_GOOGLETEST_HEAD=OFF -DABSL_PROPAGATE_CXX_STD=ON -DCMAKE_CXX_FLAGS="-fPIC"
        )
        list(APPEND TFL_DEPENDS abseil-cpp)
