...
if(tensorflow-lite_FOUND)
    ...
    ExternalProject_Add(
            ...
            CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DTFLITE_ENABLE_INSTALL=ON -DBUILD_SHARED_LIBS=OFF -DTFLITE_ENABLE_GPU=ON -DTFLITE_ENABLE_RUY=ON -DMESA_EGL_NO_X11_HEADERS -DEGL_NO_XLL
            DEPENDS ${TFL_DEPENDS}
    )
endif()