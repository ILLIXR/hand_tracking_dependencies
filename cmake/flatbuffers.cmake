...
if(flatbuffers_FOUND)
    ...
    ExternalProject_Add(
            ...
            CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DFLATBUFFERS_BUILD_TESTS=OFF -DCMAKE_CXX_FLAGS="-fPIC" -DCMAKE_C_FLAGS="-fPIC"
    )
    ...
    add_custom_target(flatbuffers-flatc
                      COMMAND ${CMAKE_COMMAND} -B ${CMAKE_BINARY_DIR}/flatbuffers-flatc -S ${CMAKE_BINARY_DIR}/${EPA}/src/${EPA} -DCMAKE_CXX_FLAGS="-fPIC"  -DCMAKE_C_FLAGS="-fPIC" -DFLATBUFFERS_BUILD_TESTS=OFF -DFLATBUFFERS_BUILD_FLATLIB=OFF -DFLATBUFFERS_STATIC_FLATC=OFF -DFLATBUFFERS_BUILD_FLATHASH=OFF -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}
